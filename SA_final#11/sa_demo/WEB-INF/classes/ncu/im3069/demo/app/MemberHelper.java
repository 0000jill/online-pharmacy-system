...
public class MemberHelper{
    ...
    public JSONObject getLogin(String login_email, String login_password) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_test`.`tbl_member` WHERE `email` = ? AND `password` = ? LIMIT 1";
    ...
    public boolean checkLogin(Member m){
        ...
        try {
            ...
            String sql = "SELECT count(*) FROM `sa_test`.`tbl_member` WHERE `email` = ? AND `password` = ?";
    ...
    public JSONObject getAll(){
        ...
        try {
            ...
            while(rs.next()) {
                ...
                /** 將每一筆會員資料產生一名新Member物件 */
                m = new Member(member_id, name, email, password, point);
                /** 取出該名會員之資料並封裝至 JSONsonArray 內 */
                jsa.put(m.getData());
            }
    ...
    public JSONObject getByID(String id){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_test`.`tbl_member` WHERE `member_id` = ? LIMIT 1";
            ...
            while(rs.next()) {
                ...
                /** 將每一筆會員資料產生一名新Member物件 */
                m = new Member(member_id, name, email, password, points);
                /** 取出該名會員之資料並封裝至 JSONsonArray 內 */
                jsa.put(m.getData());
            }
    ...
    public boolean checkDuplicate(Member m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `sa_test`.`tbl_member` WHERE `email` = ?";
    ...
    public JSONObject create(Member m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `sa_test`.`tbl_member`(`member_id`, `name`, `email`, `password`, `modified`, `created`, `points`)"
                    + " VALUES(?, ?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa_test`.`tbl_member` SET `password` = ? , `modified` = ? WHERE `email` = ?";
            /** 取得所需之參數 */
            //String name = m.getName();
            String password = m.getPassword();
