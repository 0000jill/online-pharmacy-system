...
public class ProductHelper {
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_test`.`tbl_product`";
    ...
    public JSONObject getByIdList(String data) {
      ...
      try {
          ...
          /** SQL指令 */
          String sql = "SELECT * FROM `sa_test`.`tbl_product` WHERE `tbl_product`.`product_id`";
    ...
    public Product getById(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_test`.`tbl_product` WHERE `tbl_product`.`product_id` = ? LIMIT 1";
