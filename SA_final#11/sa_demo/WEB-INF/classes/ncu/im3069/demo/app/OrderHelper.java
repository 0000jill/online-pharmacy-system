...
public class OrderHelper {
    ...
    public JSONObject create(Order order) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "INSERT INTO `sa_test`.`tbl_order`(`name`, `address`, `phone`, `pay_method`, `created`, `modified`)"
                    + " VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_test`.`tbl_order`";
            ...
            while(rs.next()) {
                ...
                String pay = rs.getString("pay_method");
                Timestamp create = rs.getTimestamp("created");
                Timestamp modify = rs.getTimestamp("modified");
                
                /** 將每一筆商品資料產生一名新Product物件 */
                o = new Order(id, name, address, phone, pay, create, modify);
    ...
    public JSONObject getById(String order_id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_test`.`tbl_order` WHERE `tbl_order`.`order_id` = ?";
